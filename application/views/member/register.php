...
<div class="register-box">
  <div class="card card-outline card-primary">
    ...
    <div class="card-body">
      ...
      <form method="post" action="<?= site_url('memberpanel/registerMember') ?>">
        <div class="input-group mb-3">
          <input type="text" class="form-control" name="namaKonsumen" placeholder="Nama Lengkap">
      ...
      <a href="<?= site_url('memberpanel/login') ?>" class="text-center">I already have a membership</a>
    </div>
    <!-- /.form-box -->
  </div><!-- /.card -->
</div>
