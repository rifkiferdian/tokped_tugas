        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-info">
              ...
              <?php endif ?>
              <form class="form-horizontal" method="post" action="<?php echo site_url('memberpanel/editProfilMember');?>">
                <div class="card-body">
                  <div class="input-group mb-3">
			          <input type="text" class="form-control" name="namaKonsumen" placeholder="Nama Lengkap" value="<?= $data->namaKonsumen ?>">
			        ...
			        <div class="input-group mb-3">
			          <input type="text" class="form-control" name="telp" placeholder="Telpon" value="<?= $data->tlpn ?>">
			          <div class="input-group-append">
			            <div class="input-group-text">
			              <span class="fas fa-user"></span>
			            </div>
